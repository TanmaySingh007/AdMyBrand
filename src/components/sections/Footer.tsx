        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          >
            <div className="flex items-center mb-4">
              <h3 className="text-2xl font-bold text-primary-400">AdMyBrand</h3>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              The all-in-one platform for modern businesses to create, manage, and scale their brand presence across all channels.
            </p>
        ...
        >
          <div className="max-w-md">
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="px-6 py-2 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors duration-300">
                Subscribe
              </button>
            </div>
          </div>
