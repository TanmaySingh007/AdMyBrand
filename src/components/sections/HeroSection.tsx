      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              The all-in-one platform for modern businesses to create, manage, and scale their brand presence across all channels with AI-powered insights.
            </motion.p>
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl p-8 border border-gray-200">
              ...
              <div className="aspect-video bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-primary-600 font-medium">Hero Image/Video</p>
                  <p className="text-primary-500 text-sm">Your compelling visual content here</p>
                </div>
              </div>
